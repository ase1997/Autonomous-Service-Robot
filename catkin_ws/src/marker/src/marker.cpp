...
double PICKUP_X = 5.15, PICKUP_Y = -4.51;					// same as in delivery.cpp
double DROPOFF_X = 2.7, DROPOFF_Y = 10.1;			// same as in delivery.cpp
int WAIT_TIME = 5;
int current_wait_ = 0;


// get x-y coordinate of robot from amcl pose
